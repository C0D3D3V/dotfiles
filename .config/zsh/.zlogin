...
export PATH=/opt/android-sdk/emulator:/opt/android-sdk/platform-tools:$PATH
export PATH=/opt/android-sdk/build-tools/$(ls /opt/android-sdk/build-tools/ | tail -n1):$PATH &>/dev/null
# PATH: RUBY
export PATH=/home/daniel/.gem/ruby/$(ls /home/daniel/.gem/ruby/ | tail -n1)/bin:$PATH &>/dev/null
# PATH: flutter
...
#export GTK_IM_MODULE=ibus # for ibus use xim
